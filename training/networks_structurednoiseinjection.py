...
def G_mapping(
    ...
    **_kwargs):                             # Ignore unrecognized keyword args.
    ...
    # StructuredCodes contains the structured code for each cell as described in the paper
    structuredCodes = tf.reshape(structuredCodes, [-1, 8*8*structuredCodeLength])
